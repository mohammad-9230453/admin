                                        ...
                                        <form novalidate="">
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="نام کاربری" value="adoptionism744" required="" data-validation-required-message="This username field is required">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            <label>نام</label>
                                                            <input type="text" class="form-control" placeholder="نام" value="Angelo Sashington" required="" data-validation-required-message="This name field is required">
                                                            <div class="help-block"></div></div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="controls">
                                                            ...
                                                            <input type="email" class="form-control" placeholder="ایمیل" value="angelo@sashington.com" required="" data-validation-required-message="This email field is required">
                                                            <div class="help-block"></div></div>
                                                    </div>
                                                ...
                                                <div class="col-12 col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>شرکت</label>
                                                        <input type="text" class="form-control" value="WinDon Technologies Pvt Ltd" placeholder="نام شرکت">
                                                    </div>
